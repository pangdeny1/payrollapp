...
<html lang="en">
  <head>
    ...
    <!-- Begin SEO tag -->
    <title> Sortable & Nestable List | Looper - Bootstrap 4 Admin Theme </title>
    <meta property="og:title" content="Sortable &amp; Nestable List">
    ...
    <script type="application/ld+json">
      {
        ...
        "@type": "WebSite",
        "url": "",
        "headline": "Sortable & Nestable List",
  ...
  <body>
              ...
              <ul class="menu">
                ...
                <li class="menu-item has-child">
                  <a href="#" class="menu-link">
                    ...
                    <span class="menu-text">Level Menu</span>
                  </a>
                  <!-- child menu -->
                  <ul class="menu">
                    <li class="menu-item">
                ...
                <li class="menu-item has-child">
                  ...
                  <ul class="menu">
                    ...
                    <li class="menu-item">
                      <a href="app-boards.html" class="menu-link">Boards</a>
                    </li>
                    <li class="menu-item">
            ...
            <div class="page-inner">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item active">
                      <a href="#">
                        <i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Components</a>
                    </li>
                  </ol>
                </nav>
              ...
              <div class="page-section">
                ...
                <div class="section-block">
                  ...
                  <p class="text-muted"> JavaScript library for reorderable drag-and-drop lists on modern browsers and touch devices. No jQuery. </p>
                </div>
                <!-- /.section-block -->
                <!-- grid row -->
                <div id="sortablemulti" class="row">
                  <!-- grid column -->
                  <div class="col-lg-6 sortable-tile">
                    <!-- .card -->
                    <section class="card card-fluid">
                      <header class="card-header drag-handle"> Draft Items </header>
                      <!-- .sortable-lists -->
                  ...
                  <div class="col-lg-6 sortable-tile">
                    <!-- .card -->
                    <section class="card card-fluid">
                      <header class="card-header drag-handle"> Publish Items </header>
                      <!-- .sortable-lists -->
                      <ul class="sortable-lists list-group list-group-flush list-group-bordered">
                        <li class="list-group-item align-items-center drag-handle">
                          <span class="drag-indicator"></span>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <!-- .card -->
                    <section class="card card-fluid">
                      <header class="card-header border-bottom-0"> Footer Menus </header>
                      <!-- .nestable -->
                      ...
                      <footer class="card-footer bg-light">
                        <a href="#" class="card-footer-item justify-content-start">
                          <span>
                            <i class="fa fa-plus-circle mr-1"></i> Add Menu Item</span>
                        </a>
                      </footer>
                      <!-- /.card-footer -->
                    </section>
                  ...
                  <div class="col-lg-6">
                    <!-- .card -->
                    <section class="card card-fluid">
                      <header class="card-header border-bottom-0"> Primary Menus </header>
                      <!-- .nestable -->
    ...
    <!-- END THEME JS -->
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/javascript/pages/sortable-nestable-demo.js"></script>
    <!-- END PAGE LEVEL JS -->
