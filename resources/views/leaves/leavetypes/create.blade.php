            ...
            <div class="page-section">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="{{ url("storeleavetype") }}"
                              method="post"
                              class="card border-0"
                        >
                            @csrf
                        ...
                        <div class="col-md-3 mb-3">
                          ...
                          <input type="text" name="maximumdays" class="form-control {{ $errors->has('maximumdays') ? 'is-invalid' : '' }}" id="maximumdays" value="{{old('maximumdays')}}"  required="">
                      ...
                      <hr class="mb-4">
                          ...
                          <textarea name="description"  class="form-control {{ $errors->has('description') ? "is-invalid" : "" }}" id="lbl4" rows="3" placeholder=" description"></textarea>
