                    ...
                    <div class="page-section">
                        <section class="card shadow-1 border-0 card-fluid">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-muted">  Showing {{ $leaveapprovallevers->firstItem() }} to {{ $leaveapprovallevers->lastItem() }} of {{ $leaveapprovallevers->total() }} entries </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @foreach($leaveapprovallevers as $leave)
                                            <tr>
                                                <td>
