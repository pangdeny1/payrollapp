        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/updatejobgroup/'.$jobgroup->id) }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group{{ $errors->has('jobgroupname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="jobgroupname" type="text" class="form-control" name="jobgroupname" value="{{ $jobgroup->jobgroupname }}">
                        ...
                        <div class="form-group{{ $errors->has('jobgroupdesc') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea rows="10" id="jobgroupdesc" class="form-control" name="jobgroupdesc">{{ $jobgroup->jobgroupdesc }}</textarea>
                       ...
                       <div class="form-group{{ $errors->has('level') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="level" type="number" class="form-control" name="level" value="{{ $jobgroup->level }}">
