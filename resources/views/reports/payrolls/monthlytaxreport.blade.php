        ...
        <table class="table table-sm table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="text-right"  nowrap>Tax Number</th>
                    <th class="text-right"  nowrap>Tax Type</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td nowrap class="text-right">
                     {{number_format($payrolltransaction->tax,2)}}
                    </td>
            ...
            <tfoot>
                <tr>
                    ...
                    <th nowrap class="text-right"></th>
                    <th nowrap class="text-right"></th>
                    <th nowrap class="text-right"> {{number_format($payrolltransactions->sum('tax'),2)}} </th>
