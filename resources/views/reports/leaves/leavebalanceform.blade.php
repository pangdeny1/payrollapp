        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('leavebalancereport') }}">
                        {!! csrf_field() !!}
                          ...
                          <!-- grid column -->
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="form-group">
                              <label for="as_ondate">Balance as on</label>
                              <input name="as_ondate" type="date"
                               id="as_ondate"
                                                           class="form-control  {{ $errors->has('as_ondate') ? "is-invalid" : "" }}"
                                                           value="{{date('Y-m-d')}}"
                                                            >

                               @if ($errors->has('as_ondate'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('as_ondate') }}</strong>
                                    </span>
                                @endif
                            </div>
                          <div class="col-md-6">
