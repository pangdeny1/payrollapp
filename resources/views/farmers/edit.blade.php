            ...
            <div class="page-section">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="{{ route("farmers.update",$farmer) }}"
                              method="POST"
                              class="card border-0"
                        >
                            @csrf
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="custom-control custom-control-inline custom-radio">
                                                <input type="radio"
                                                       ...
                                                       name="gender"
                                                       id="female"
                                                       {{ old("gender", $farmer->gender) === "female" ? "checked" : "" }}
                                                       value="female"
                                                >
                                            ...
                                            <div class="custom-control custom-control-inline custom-radio">
                                                <input type="radio"
                                                       class="custom-control-input"
                                                       name="gender"
                                                       {{ old("gender", $farmer->gender) === "male" ? "checked" : "" }}
                                                       id="male"
                                                       value="male"
                                                >
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text"
                                                   ...
                                                   id="street"
                                                   value="{{ old("street", optional($farmer->address)->street) }}"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old("address", optional($farmer->address)->address) }}"
                                            >
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            >
                                                ...
                                                @foreach($states as $key => $state)
                                                    <option name="{{ $state["name"] }}" {{ old("state", optional($farmer->address)->state) === $state["name"] ? "selected" : "" }}>
                                                        {{ $state["name"] }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   id="postal_code"
                                                   value="{{ old("postal_code", optional($farmer->address)->postal_code) }}"
                                            >
