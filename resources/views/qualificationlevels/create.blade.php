        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/addqualificationlevel') }}">
                        {!! csrf_field() !!}
                            ...
                            <div class="col-md-6">
                                <input type="text" name="QlevelName" class="form-control" value="{{old('QlevelName')}}">
                        ...
                        <div class="form-group{{ $errors->has('QlevelDesc') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="QlevelDesc" class="form-control" value="{{old('QlevelDesc')}}">
