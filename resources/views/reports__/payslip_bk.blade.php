<?php
 $db="medahr";
   ...
   // mysqli_select_db($mysqli, $db) or die('Erreur de connection à la BDD : ' .mysqli_connect_error());
    ...
    $mysqli= mysqli_connect("localhost","root","") or die ("could not connect to mysql"); 

     mysqli_select_db($mysqli,"medahr") or die ("no database");  
    // FORCE UTF-8
//    mysqli_query($mysqli, "SET NAMES UTF8");
   ...
   // $sql = 'select count(*) FROM  prlpayrolltrans where  employeeid=' .$var_id_facture;
    ...
    While ($num_page <= $nb_page)
    {
        ...
        $pdf->Image("includes/logo.png", 10, 10, 80, 55);
