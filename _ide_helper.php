 ...
 * Generated for Laravel 5.6.26 on 2018-07-10 11:42:35.
 *
...
namespace App\Facades { 
    ...
    class SmsFacade {
         ...
         * @static 
         */ 
        public static function send($receiver, $body)
        {
            return \App\SmsNotification::send($receiver, $body);
        }
         ...
         * @static 
         */ 
        public static function body($receiver, $content)
        {
            return \App\SmsNotification::body($receiver, $content);
        }
         ...
         * @static 
         */ 
        public static function renderXml($receiver, $content)
        {
            return \App\SmsNotification::renderXml($receiver, $content);
        }
         ...
         * @static 
         */ 
        public static function convertToXml($data, $node)
        {
            return \App\SmsNotification::convertToXml($data, $node);
        }
...
namespace Nexmo\Laravel\Facade { 
    ...
    class Nexmo {
        ...
        {
            return \Nexmo\Client::setHttpClient($client);
        }
        ...
        {
            return \Nexmo\Client::getHttpClient();
        }
        ...
        {
            return \Nexmo\Client::setFactory($factory);
        }
         ...
         * @static 
         */ 
        public static function generateJwt($claims = array())
        {
            return \Nexmo\Client::generateJwt($claims);
        }
        ...
        {
            return \Nexmo\Client::get($url, $params);
        }
        ...
        {
            return \Nexmo\Client::post($url, $params);
        }
        ...
        {
            return \Nexmo\Client::postUrlEncoded($url, $params);
        }
        ...
        {
            return \Nexmo\Client::put($url, $params);
        }
        ...
        {
            return \Nexmo\Client::delete($url);
        }
        ...
        {
            return \Nexmo\Client::send($request);
        }
        ...
        {
            return \Nexmo\Client::serialize($entity);
        }
        ...
        {
            return \Nexmo\Client::unserialize($entity);
        }
...
namespace  { 
    ...
    class Sms extends \App\Facades\SmsFacade {}
